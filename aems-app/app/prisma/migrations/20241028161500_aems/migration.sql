-- CreateEnum
CREATE TYPE "enum_stage" AS ENUM ('Create', 'Read', 'Update', 'Delete', 'Process', 'Complete', 'Fail');

-- CreateEnum
CREATE TYPE "enum_holiday" AS ENUM ('Enabled', 'Disabled', 'Custom');

-- CreateTable
CREATE TABLE "Units" (
    "id" SERIAL NOT NULL,
    "stage" "enum_stage" NOT NULL DEFAULT 'Create',
    ...
    "bldgType" VARCHAR(1024) NOT NULL DEFAULT '',
    "operator" VARCHAR(1024) NOT NULL DEFAULT '',
...
CREATE TABLE "Setpoints" (
    ...
    "supplyDuctPressure" DOUBLE PRECISION NOT NULL DEFAULT 230,
    "coolingCoilValve" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "heatingCoilValve" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "coolingCoilPump" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "heatingCoilPump" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "supplyFanSpeed" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "supplyAirSetpoint" DOUBLE PRECISION NOT NULL DEFAULT 70,
    "supplyHeaterSetpoint" DOUBLE PRECISION NOT NULL DEFAULT 70,
    "outsideAirDamperPosition" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "returnAirDamperPosition" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "zoneDamperPosition" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "zoneReheatControl" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
    "zoneAirCoolingSetpoint" DOUBLE PRECISION NOT NULL DEFAULT 80,
    "zoneAirHeatingSetpoint" DOUBLE PRECISION NOT NULL DEFAULT 60,  
